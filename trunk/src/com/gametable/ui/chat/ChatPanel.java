...
import com.gametable.data.ChatEngineIF;
import com.gametable.data.Player;
import com.gametable.ui.FloatingWindow;
...
//        }
    ...
    /*
    * @see com.gametable.data.ChatEngineIF#clearMessages()
    */
    @Override
    ...
    /*
    * @see com.gametable.data.ChatEngineIF#displayMessage(com.gametable.data.ChatEngineIF.MessageType, java.lang.String)
    */
    @Override
    ...
    /*
    * @see com.gametable.data.ChatEngineIF#onPlayersChanged()
    */
    @Override
