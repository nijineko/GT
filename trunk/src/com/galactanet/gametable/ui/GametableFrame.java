...
import com.galactanet.gametable.data.net.NetworkThread;
import com.galactanet.gametable.data.net.Packet;
...
//    private boolean                 b_chatWindowDocked       = true;
    ...
    public void discardCards(final Card discards[])
    {
        ...
        // @revuse This is a very expensive algorithm, it would be better to get to the card to remove directly by index or something like that.
...
//        });
    ...
    public Pog makeCardPog(final Card card)
    {
        ...
        final PogType newPogType = getPogLibrary().getPog("pogs" + UtilityFunctions.LOCAL_SEPARATOR + card.getCardFile());
...
//    }
     ...
     * @param size
     */
    public void pogLayerPacketReceived(final int id, final Type layer)
    {
