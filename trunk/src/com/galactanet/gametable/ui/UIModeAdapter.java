...
public class UIModeAdapter implements UIModeListener
{
	...
	/*
	 * @see com.galactanet.gametable.ui.UIModeListener#mouseButtonPressed(com.galactanet.gametable.data.MapCoordinates, int)
	 */
	@Override
	public void mouseButtonPressed(GametableCanvas canvas, int mouseX, int mouseY, int modifierMask) {}

	/*
	 * @see com.galactanet.gametable.ui.UIModeListener#mouseButtonReleased(com.galactanet.gametable.data.MapCoordinates, int)
	 */
	@Override
	public void mouseButtonReleased(GametableCanvas canvas, int mouseX, int mouseY, int modifierMask) {}

	/*
	 * @see com.galactanet.gametable.ui.UIModeListener#mouseMoved(com.galactanet.gametable.data.MapCoordinates, int)
	 */
	@Override
