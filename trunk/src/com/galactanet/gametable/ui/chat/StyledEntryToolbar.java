...
public class StyledEntryToolbar extends JPanel
{
    ...
    private void initialize()
    {
        ...
        boldButton = new JToggleButton(new ImageIcon(ImageCache.getImage(new File("assets/bold.png"))));
        ...
        italicsButton = new JToggleButton(new ImageIcon(ImageCache.getImage(new File("assets/italics.png"))));
        ...
        underlineButton = new JToggleButton(new ImageIcon(ImageCache.getImage(new File("assets/underline.png"))));
