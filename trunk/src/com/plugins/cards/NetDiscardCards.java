 ...
 * 
 */
public class NetDiscardCards implements NetworkMessageTypeIF
{
	/**
	 * Singleton factory method
	 * @return
	 */
	public static NetDiscardCards getMessageType()
	{
		if (g_messageType == null)
			g_messageType = new NetDiscardCards();
	 ...
	 * Singleton instance
	 */
	private static NetDiscardCards g_messageType = null;

	public static byte[] makePacket(final String playerName, final Card cards[])
	{
		try
		{
