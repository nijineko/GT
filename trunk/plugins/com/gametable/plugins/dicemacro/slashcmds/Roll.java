...
import com.gametable.plugins.dicemacro.DiceMacro;
...
public class Roll extends SlashCommand
{
	...
	public String processCommand(String words[], String text)
	{
		...
		{
			GametableApp.getCore().sendMessageLocal(MessageType.MECHANIC, "<b><font color=\"#880000\">Error in Macro String.</font></b>");
		}
