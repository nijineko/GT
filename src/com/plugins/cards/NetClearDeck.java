 ...
 * Clear deck
 */
public class NetClearDeck implements NetworkMessageTypeIF
{
	/**
	 * Singleton factory method
	 * @return
	 */
	public static NetClearDeck getMessageType()
	{
		if (g_messageType == null)
			g_messageType = new NetClearDeck();
	 ...
	 * Singleton instance
	 */
	private static NetClearDeck g_messageType = null;
	
	/**
	 * Create a message requesting to clear a deck
	 * 
	 * @param deckName
	 * @return
	 */
	public static byte[] makePacket(final String deckName)
	{
		try
		{
