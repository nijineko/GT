 ...
 */
public class NetKeepAlive implements NetworkMessageTypeIF
{
	/**
	 * Singleton factory method
	 * @return
	 */
	public static NetKeepAlive getMessageType()
	{
		if (g_messageType == null)
			g_messageType = new NetKeepAlive();
	 ...
	 * Singleton instance
	 */
	private static NetKeepAlive g_messageType = null;
	
	/**
	 * Private constructor 
	 */
	private NetKeepAlive()
	{
	}
	...
	{
		// there is nothing to do on a ping.
	}
