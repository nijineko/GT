 ...
 */
public class NetRequestDictionary implements NetworkMessageTypeIF
{
	/**
	 * Singleton factory method
	 * @return
	 */
	public static NetRequestDictionary getMessageType()
	{
		if (g_messageType == null)
			g_messageType = new NetRequestDictionary();
	 ...
	 * Singleton instance
	 */
	private static NetRequestDictionary g_messageType = null;
	
	/**
	 * Private constructor 
	 */
	private NetRequestDictionary()
	{
	}
	
	/**
	 * Create a dictionary request packet
	 * @return
	 */
