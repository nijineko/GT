...
import com.galactanet.gametable.Deck;
import com.galactanet.gametable.DeckData;
...
public class PacketManager
{
     ...
     * @return
     */
    public static byte[] makeGroupPacket(final int action, final String group, final int pog, final int player) {
        try
        {
            final ByteArrayOutputStream baos = new ByteArrayOutputStream();
            final DataOutputStream dos = new DataOutputStream(baos);
