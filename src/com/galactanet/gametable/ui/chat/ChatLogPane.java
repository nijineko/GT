...
/*        if (privMsg)
        {
//            playerA = GametableFrame.getGametableFrame().getMyPlayerId(); // never used locally
...
//                logAlertMessage("There is no player or character named \"" + toName + "\" in the session.");
        ...
        */
        ...
        if(m_id == 0)
        addText("Welcome to <a href=\"http://sourceforge.net/projects/gametable//\">" + GametableApp.VERSION + "</a>." + GametableApp.BUILD);
    }
