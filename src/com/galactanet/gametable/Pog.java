    ...
    public void drawToCanvas(final Graphics g)
    {
        ...
        if (visbleCanvas.intersects(getBounds(m_canvas)))
        {
           ...
           /* drawScaled(g, drawCoords.x, drawCoords.y, scale * m_scale);
            ...
            if (m_bTinted)
            {
                m_pogType.drawTint(g, drawCoords.x, drawCoords.y, scale * m_scale, 
                Color.GREEN, m_angle, m_forceGridSnap);
            }
            */
            ...
            } else drawScaled(g, drawCoords.x, drawCoords.y, scale * m_scale);
        }
    }
...
//            drawWidth, drawHeight);
    ...
    private void init(final Pog orig, final boolean copygroup)
    {
    ...
    private void initFromPacket(final DataInputStream dis) throws IOException
    {
        ...
        try {
            m_forceGridSnap = dis.readBoolean(); //#gridsnap
        }
        catch(IOException exp)
        {
