...
/**
 * Line drawing UI mode
 * 
 * @author iffy
 * 
 *         #GT-AUDIT LineTool
 */
public class LineMode extends UIMode
{
	/**
	 ...
	 * @return
	 */
	public static final LineMode getUIMode()
	{
		if (g_mode == null)
			g_mode = new LineMode();
	...
	private LineMode()
	{
		...
		UIModeAction action = new UIModeAction(
				this, 
				"Line",
				"Draw a line on the current map",
				KeyEvent.VK_4,
				"line.png");
	 ...
	 */
	private static LineMode				g_mode	= null;

	/**
	 * Line cursor
	 */
	private final Cursor m_cursorLine;
	...
	private class ModeListener implements UIModeListener
	{
		...
		public void mouseButtonReleased(GametableCanvas canvas, int mouseX, int mouseY, final int modifierMask)
		{
			if (m_mouseAnchor != null)
			{
				final LineSegment ls = new LineSegment(m_mouseAnchor, m_mouseFloat, m_frame.getDrawColor());
		...
		public void selectMode()
		{
			m_mouseAnchor = null;
			m_mouseFloat = null;
			m_frame.setMapCursor(m_cursorLine);
		}
	}
}
