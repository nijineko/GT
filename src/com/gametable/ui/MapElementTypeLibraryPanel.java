/*
 * MapElementTypeLibraryPanel.java
 * 
 * @created 2009-06-18
 * 
...
/**
 * Tree-based map element library panel.
 * 
 * @author iffy
 * 
 *         #GT-AUDIT MapElementTypeLibraryPanel
 */
public class MapElementTypeLibraryPanel extends JPanel
{
	// --- Constants -------------------------------------------------------------------------------------------------
	 ...
	 */
	public MapElementTypeLibraryPanel(final MapElementTypeLibrary library, final GametableCanvas canvas)
	{
		m_library = library;
		m_canvas = canvas;
		initialize();
	...
	private JTree getPogTree()
	{
		if (pogTree == null)
		{
			...
			pogTree.addMouseMotionListener(new MouseMotionAdapter() {
				...
				{
					final Point screenCoords = UtilityFunctions.getScreenCoordinates(pogTree, new Point(e.getX(), e.getY()));
					m_mousePosition = UtilityFunctions.getComponentCoordinates(MapElementTypeLibraryPanel.this, screenCoords);
