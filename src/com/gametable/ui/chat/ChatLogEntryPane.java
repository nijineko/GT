...
public class ChatLogEntryPane extends JEditorPane
{
        ...
        final AttributeSet styleOff)
    {
        ...
        for (LeafElement element : getElementsIn(doc, start, end))
        {
    ...
    private static List<LeafElement> getElementsIn(final HTMLDocument doc, final int start, final int end)
    {
        final List<LeafElement> retVal = new ArrayList<LeafElement>();
        int pos = start;
        while (true)
        {
